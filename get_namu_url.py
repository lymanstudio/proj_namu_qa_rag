...
class GetNamuUrl:
    ...
    def __init__(self, google_api_key, search_engine_key, rev_exclude:bool = False, crucial_keyword = False, verbose = False):
        """API 환경 설정"""
        self.google_api_key = google_api_key
        self.search_engine_key = search_engine_key
        self.verbose = verbose
        self.crucial_keyword = crucial_keyword
        self.rev_exclude = "판)" if rev_exclude else ""
